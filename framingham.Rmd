...
### BIN 1
bin1ps <- glm( cigsPerDay_bin_1 ~   education + age + diabetes + bmi , data = fhs_binned, family = "binomial")
ps1 <- predict(glm_fit_iptw_bin_1, type= "response")
summary(ps1)

### BIN 2
bin2ps <- glm( cigsPerDay_bin_2 ~   education + age + diabetes + bmi , data = fhs_binned, family = "binomial")
ps2 <- predict(glm_fit_iptw_bin_2, type= "response")
summary(ps2)

### BIN 3
bin3ps <- glm( cigsPerDay_bin_3 ~   education + age + diabetes + bmi , data = fhs_binned, family = "binomial")
ps3 <- predict(glm_fit_iptw_bin_3, type= "response")
summary(ps3)

### BIN 4
bin4ps <- glm( cigsPerDay_bin_4 ~   education + age + diabetes + bmi , data = fhs_binned, family = "binomial")
ps4 <- predict(glm_fit_iptw_bin_4, type= "response")
summary(ps4)
```
