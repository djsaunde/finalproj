...
fhs_binned$cigsPerDay  <- factor(bin_data(fhs$cigsPerDay,bins=c(0,.9,10,20,30,40,50,60,max(fhs$cigsPerDay)), binType = "explicit"))
...
average_treatment_effect_ci <- matrix(NA,nrow=8,ncol=2)
for (i in 1:8){
...
plot(average_treatment_effect,type='l',xlab="Half-Packs per Day",ylab="Probability of CHD",ylim=c(0,.5))
