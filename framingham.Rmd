...
SL.exposure<- SuperLearner(Y=as.numeric(fhs_binned$CHD==1), X=subset(X_minus_bin_1, select= -c(cigsPerDay_bin_1)),SL.library=SL.library, family="binomial")
...
H.AW<- as.numeric(fhs_binned$cigsPerDay_bin_1==1)/probA1.givenW# - as.numeric(fhs_binned$cigsPerDay_bin_1==0)/probA0.givenW
...
PsiHat.TMLE <- mean(expY.givenAW.star)#- expY.given0W.star)
```
